package cn.com.enorth.cebx.interceptor;
...
public class PageInterceptor implements Interceptor {
	...
	private void getOrderSql(Page<?> page, StringBuffer sqlBuffer) {
		sqlBuffer.append(" order by ").append(page.getSidx()).append(" " + page.getSord());
	}
